...
| Run a goal until the first review artifact or hard stop | `npx --yes --package @jununfly/zj-loop-core@0.1.8 zj-loop-run "Implement this PRD"` |
| Diagnose why recent loops stopped | `npx --yes --package @jununfly/zj-loop-core@0.1.8 zj-loop-doctor` |
| Plan the first automation-default run | `npx --yes --package @jununfly/zj-loop-core@0.1.8 zj-loop-first-run plan` |
...
```bash
npx --yes --package @jununfly/zj-loop-core@0.1.8 zj-loop-route disable roadmap-sliced-development
```
...
```bash
npx --yes --package @jununfly/zj-loop-core@0.1.8 zj-loop-doctor --format text
npx --yes --package @jununfly/zj-loop-core@0.1.8 zj-loop-doctor --orchestration orch_123
npx --yes --package @jununfly/zj-loop-core@0.1.8 zj-loop-doctor --provider github --subject issue:123
npx --yes --package @jununfly/zj-loop-core@0.1.8 zj-loop-doctor --write-index zj-loop/evidence-index.json
```

Replay the runtime gate without entering a consumer runner:

```bash
npx --yes --package @jununfly/zj-loop-core@0.1.8 zj-loop-preflight --route roadmap-sliced-development --execution-layer review-artifact --json
```
