...
**从这里开始：** [产品体验报告](https://jununfly.github.io/ZAgenticLoop/docs/product-experience-report.zh-CN.html) · [Quickstart](docs/QUICKSTART.md) · [Pattern picker](docs/pattern-picker.md) · [Primitives matrix](docs/primitives-matrix.md) · [Release playbook](docs/RELEASE.md)
...
- **证据来源：** pattern catalog 由 [registry metadata](patterns/registry.yaml)、[production stories](stories/) 和完整的 [产品体验报告](https://jununfly.github.io/ZAgenticLoop/docs/product-experience-report.zh-CN.html) 支撑。
