...
| `@jununfly/zj-loop-init` | `zj-loop-init` | 初始化 starters、state files、budget 和 run logs | `0.1.1` |
| `@jununfly/zj-loop-audit` | `zj-loop-audit` | Loop Readiness Score 和建议 | `0.1.0` |
| `@jununfly/zj-loop-cost` | `zj-loop-cost` | 按 pattern、level、cadence 估算 token 开销 | `0.1.1` |
