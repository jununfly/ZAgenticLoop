...
```bash
npx --yes --package @jununfly/zj-loop-core@0.1.5 zj-loop-route enable roadmap-sliced-development --confirm "enable roadmap-sliced-development side effects"
npx --yes --package @jununfly/zj-loop-core@0.1.5 zj-loop-route enable ci-sweeper --confirm "enable ci-sweeper side effects"
npx --yes --package @jununfly/zj-loop-core@0.1.5 zj-loop-route enable post-merge-roadmap-closeout --confirm "enable post-merge-roadmap-closeout side effects"
```
