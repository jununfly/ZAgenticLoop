...
| Automatic trigger performs dry-run only; live cleanup requires local maintainer command or workflow_dispatch with a fixed confirmation phrase. | durable doc | This test case and `.github/workflows/post-merge-roadmap-closeout.yml`. |
