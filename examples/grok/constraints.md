...
The agent appends your rules to `zj-loop/zj-loop-constraints.md`.
...
2. The `zj-loop-constraints` skill (from `templates/SKILL.md.zj-loop-constraints`) must be installed in `.grok/skills/zj-loop-constraints/SKILL.md`
