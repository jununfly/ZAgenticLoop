...
- **Cobus Greyling** — [ZAgenticLoop](https://jununfly.github.io/ZAgenticLoop) (June 2026)
  Companion essay for this repository: context engineering vs harness engineering vs agentic loop working, the five primitives + memory, Grok mapping, and production realities.

- **Addy Osmani** — [ZAgenticLoop](https://addyosmani.com/blog/zagenticloop/) (June 2026)
...
- Various practitioners experimenting with closed-loop systems, feedback agentic loop working, and "routines that prompt the model."
