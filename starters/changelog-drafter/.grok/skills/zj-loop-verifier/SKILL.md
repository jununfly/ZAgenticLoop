---
name: zj-loop-verifier
description: >
  Independent checker for release note drafts. Reviews accuracy against the
  zj-changelog-scan data, tone, completeness, and flags breaking/security items.
  Use after zj-draft-release-notes. Never let the drafter verify itself.
user_invocable: true
---
...
- The draft produced by zj-draft-release-notes
