...
export function artifactCandidates<T extends { primary: string; legacy: readonly string[] }>(artifact: T): string[] {
  return [artifact.primary, ...artifact.legacy];
}

export function skillPathCandidates(skillNames: readonly string[]): string[] {
