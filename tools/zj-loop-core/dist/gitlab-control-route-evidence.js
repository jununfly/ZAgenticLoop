...
export const GITLAB_CONTROL_ROUTES = ['human', 'ignore'];
export function buildGitLabControlRouteEvidence(input) {
    const base = {
    ...
    if (!GITLAB_CONTROL_ROUTES.includes(input.routeId)) {
...
function compatibilityFingerprint(value) {
