...
const DECLARED_CAPABILITIES = ['webhook-envelope-validation', 'receipt-dedupe', 'fixed-api-trigger'];
const VERIFIERS = ['route-table', 'disabled-state', 'zero-side-effect'];
export function buildGitLabIssueNoteBridgeCapabilityArtifact(route) {
