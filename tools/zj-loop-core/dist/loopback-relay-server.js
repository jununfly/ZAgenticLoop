...
export const RELAY_HTTP_SCHEMA = 'zj-loop.relay_http.v1';
...
async function readBody(request) {
    ...
    if (declared > MAX_RELAY_BODY_BYTES)
        throw new Error('relay-envelope-too-large');
    const chunks = [];
    let size = 0;
