...
export declare const DEFAULT_LOOP_SKILL_NAMES: readonly ["loop-triage", "minimal-fix", "loop-verifier", "pr-review-triage", "ci-triage", "post-merge-scan", "dependency-triage", "rebase-and-clean", "changelog-scan", "zj-loop-constraints", "zj-loop-budget", "draft-release-notes", "issue-triage"];
