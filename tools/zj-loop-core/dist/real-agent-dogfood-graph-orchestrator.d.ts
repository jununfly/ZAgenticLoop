...
export declare const REAL_AGENT_DOGFOOD_GRAPH_EDGES: {
    from: "cleanup" | "merge" | "source_execution" | "scope_observation" | "independent_verification" | "human_acceptance" | "post_merge_gate";
    to: "cleanup" | "merge" | "source_execution" | "scope_observation" | "independent_verification" | "human_acceptance" | "post_merge_gate";
}[];
