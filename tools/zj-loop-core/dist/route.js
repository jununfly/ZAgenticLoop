...
const COMPLETION_TARGET_APPLICABILITY = new Set([
    'applicable',
...
function validateCompletionTargetContract(table) {
    ...
    for (const route of routes) {
        ...
        for (const [adapterId, target] of Object.entries(adapters ?? {})) {
            ...
            if (!COMPLETION_TARGET_APPLICABILITY.has(target.applicability)) {
