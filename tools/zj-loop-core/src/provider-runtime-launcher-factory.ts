...
import { createProviderAuthRuntimeIpcLauncher, type ProviderAuthRuntimeIpcLauncher } from './provider-auth-runtime-ipc-launcher.js';
import type { ProviderAuthRuntime, ProviderRuntimeIdentityBinding } from './provider-auth-runtime.js';
...
export function createMacOSProviderRuntimeLauncher(input: {
  ...
  const launcher = createProviderAuthRuntimeIpcLauncher({
    ...
    runtime_binding: input.config.runtime_binding as ProviderRuntimeIdentityBinding,
