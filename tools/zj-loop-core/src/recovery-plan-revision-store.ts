...
import { createRecoveryPlanRevisionRecord, type RecoveryPlanRevisionRecord } from './recovery-plan-revision.js';
import type { SqliteStateStore } from './sqlite-state-store.js';

export const RECOVERY_PLAN_REVISION_FACT_SCHEMA = 'zj-loop.recovery_plan_revision_fact.v1' as const;
...
export async function persistRecoveryPlanRevisionRecord(input: {
  ...
  if (typeof json !== 'string') throw new Error('recovery-plan-revision-artifact-invalid');
