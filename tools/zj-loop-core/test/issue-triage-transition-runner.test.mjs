...
test('Issue Triage Transition confirms ready-for-agent into brief and Issue Fix Request plan', () => {
...
test('Issue Triage Transition confirms needs-info without Issue Fix Request plan', () => {
