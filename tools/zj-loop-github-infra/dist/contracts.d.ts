export declare const GITHUB_INFRA_CONTRACT: "zj-loop.github-infra.v1";
export declare const GITHUB_INFRA_VERSION: "0.1.0";
export declare const GITHUB_API_VERSION: "2022-11-28";
export declare const READ_CAPABILITIES: readonly ["workflow-run-read", "check-read", "artifact-read", "commit-read", "ref-read"];
...
export interface InfraProvenance {
    contract: typeof GITHUB_INFRA_CONTRACT;
    infra_version: typeof GITHUB_INFRA_VERSION;
    api_version: typeof GITHUB_API_VERSION;
    repository: string;
    workflow_id: number;
    run_id: number;
    job_id: number;
...
export interface CapabilityResult {
    schema: 'zj-loop.github_infra_capability.v1';
...
export interface ProvenanceResult {
    schema: 'zj-loop.github_infra_provenance.v1';
    status: 'ready' | 'blocked';
    side_effects_executed: false;
    run: NormalizedWorkflowRun | null;
    job: NormalizedJob | null;
    check: NormalizedCheck | null;
    artifact: NormalizedArtifact | null;
    commit: NormalizedCommit | null;
    ref: NormalizedRef | null;
    evidence: ArtifactRead | null;
    provenance: InfraProvenance | null;
    errors: Array<{
        code: InfraErrorCode;
        message: string;
        status?: number;
...
export declare const DEFAULT_ARTIFACT_LIMITS: ArtifactLimits;
