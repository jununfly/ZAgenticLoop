...
export declare const GITLAB_INFRA_VERSION: "0.1.1";
export declare const READ_CAPABILITIES: readonly ["schedule-read", "pipeline-read", "job-read", "artifact-read", "issue-read", "merge-request-read", "branch-read", "note-read"];
