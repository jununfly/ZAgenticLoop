export declare const LOOP_ARTIFACTS: {
    ...
    readonly skills: {
        readonly budget: "zj-loop-budget";
        readonly constraints: "zj-loop-constraints";
        readonly budgetTemplate: "SKILL.md.zj-loop-budget";
        readonly constraintsTemplate: "SKILL.md.zj-loop-constraints";
    };
};
