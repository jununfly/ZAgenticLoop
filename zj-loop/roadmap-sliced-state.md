...
|------|--------|----------|-------------|
| 2-2-dependency-sweeper-live-runner | completed | `scripts/dependency-sweeper-live-runner.mjs`; `scripts/dependency-sweeper-live-runner.test.mjs`; `scripts/issue-fix-request-dispatcher.mjs`; `zj-loop/dependency-sweeper-state.md`; Route Table/doc updates; `node --test scripts/dependency-sweeper-live-runner.test.mjs scripts/dependency-sweeper-claim-e2e-replay.test.mjs scripts/dependency-sweeper-route-e2e-replay.test.mjs scripts/live-runner-contract.test.mjs`; `git diff --check` | pending |
