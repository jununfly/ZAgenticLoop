...
|------|--------|----------|-------------|
| 2-5-route-specific-execution-apis | in-progress | Next slice: move concrete repair/draft/cleanup execution planning and evidence builders out of repository-local `scripts/` into package APIs behind narrow commands | pending |
